                    ...
                    <div class="row gx-3">
                        <div class="col-12">
                            <div class="d-flex flex-column">
                                <p class="text mb-1">Nombre del titular</p> <input class="form-control mb-3" type="text" placeholder="Nombre" value="" id="username">
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="d-flex flex-column">
...
function validateCard(){
  let cardName = document.getElementById("username").value;
...
function validateBank(){
  let bankUsername = document.getElementById("username").value;
...
function validate(adress, street, corner){
  let paySelected = document.getElementById("username");
